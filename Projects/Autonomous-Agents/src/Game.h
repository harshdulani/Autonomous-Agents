...
public:
	...
	std::weak_ptr<class ImplicitGrid> GetCollisionSystem() const;
	std::weak_ptr<class GroupAttackingPolicy> GetGroupAttackingPolicy() const;
...
private:
	std::weak_ptr<class PlayerShip> player_;
