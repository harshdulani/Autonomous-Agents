...
{
	SetScale(Math::LerpClamped(initialScaleValue_,
							   initialScaleValue_,
							   lifeTime));
}
...
{
	renderColor_ = Math::LerpColor(initialColor_, finalColor_, lifeTime);
}
